...
def main():
    ...
    if not Path(zip_path).exists():
        print(
            "Please update the zip_path variable to point to your Transkribus ZIP file"
        )
    ...
    converter = XmlConverter(zip_path)
    ...
    print(
        "Make sure to set your HF_TOKEN environment variable or pass the token parameter"
    )
    print()
